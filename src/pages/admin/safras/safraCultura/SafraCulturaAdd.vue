<template>
  <custom-page isChild>
    <toolbar slot="toolbar" navigation_type="back" @navigation_clicked="backAction" title="Nova Safra">
      <q-btn slot="action_itens" flat dense round icon="done" @click="saveSafraCultura()" v-if="currentStep === 'culturas'"/>
    </toolbar>
    ...
    <q-stepper ref="stepper" color="positive" v-model="currentStep">
      ...
      <q-step title="Selecionar Área(s)" name="area">
  ...
  export default {
    ...
    methods:{
      ...
      saveSafraCultura: function(){
        ...
        safraService.saveSafraCultura(this.safra.getValues()).then(response => {
