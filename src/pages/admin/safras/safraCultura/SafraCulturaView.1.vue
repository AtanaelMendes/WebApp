<template>
  <custom-page isParent v-if="safraCultura">
    ...
    <div class="row">
      <div class="col-12">
    <q-tabs>
      <q-tab slot="title" name="tab-nova" label="nova" default/>
      <q-tab slot="title" name="tab-geral" label="geral" />
      <q-tab slot="title" name="tab-cultivares" label="Cultivares"/>
      <template v-for="area in areasPorId">
        <q-tab slot="title" :name="'tab-area-' + area.id" :label="area.nome"/>
      </template>

      <q-tab-pane name="tab-nova">
      ...
      <!-- CULTIVARES -->
      <q-tab-pane name="tab-cultivares">
      ...
      <template v-for="area in areasPorId">
        <q-tab-pane :name="'tab-area-' + area.id">
          <div class="row gutter-sm space-end">
