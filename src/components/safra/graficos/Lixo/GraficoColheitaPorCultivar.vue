...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // Busca Dados da API
      getData () {
        safraCulturaGraficoService.getColheitaPorCultivar(this.safraId, this.safraCulturaId).then(response => {
      ...
      parseData () {
        ...
        this.chartdata.labels = this.data.cultivares
        if (this.media) {
