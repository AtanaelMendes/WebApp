    ...
    children: [
      ...
      { name: 'areas', path: 'areas', component: () => import('pages/admin/areas/AreaList.vue'),
        children: [
          ...
          { name: 'add_area', path: 'add', component: () => import('pages/admin/pessoas/PessoaAdd.vue') }
          // { name: 'edit_area', path: 'edit/:id', component: () => import('pages/admin/pessoas/PessoaEdit.vue') }
        ]
      },
